        ...
        <div class="space-y-12">
            ...
            <div class="bg-white/80 backdrop-blur-xl border border-slate-200 shadow-sm rounded-2xl p-8 border-l-4 border-l-purple-500 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                ...
                <div class="prose max-w-none text-gray-600">
                    ...
                    <ul>
                        <li><strong>Preferences Engine:</strong> Integrated via the `NotificationPreference` database model. You have granular control over what events (e.g. `notify_on_interview`, `notify_on_failed`) and what channels (e.g. `channel_slack`, `channel_whatsapp`, `channel_in_app`) trigger alerts via the dedicated Settings page.</li>
                        <li><strong>Multi-Channel Integrations:</strong> A unified helper `notifyChannels()` on the `User` model bridges all our backend workers—from the Puppeteer scraper to the IMAP email parser—to push instantaneous rich-text updates straight to your Slack workspace and WhatsApp (via CallMeBot API).</li>
