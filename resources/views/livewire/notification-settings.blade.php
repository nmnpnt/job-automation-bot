                    ...
                    <div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl shadow-slate-200/40 border border-white/50 relative overflow-hidden group transition-colors duration-300">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-gray-100 hover:shadow-sm transition-all duration-300">
                                <div>
                                    <h4 class="text-sm font-bold text-gray-800">Scraper Completed</h4>
                                    <p class="text-xs text-gray-500 mt-0.5">Get a summary alert when the bot finishes scraping jobs.</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-gray-100 hover:shadow-sm transition-all duration-300">
                                <div>
                                    <h4 class="text-sm font-bold text-gray-800">Duplicate Skipped</h4>
                                    <p class="text-xs text-gray-500 mt-0.5">Log an alert if the bot skips a job because it was already discovered previously.</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer ml-4">
